...
export class HomeController {
    ...
    createHome(@Res() Res, @Body() createHomeDto: createHomeDto) {
        this.HomeService.createOne(createHomeDto).then((home) =>{
    ...
    @Put(':id')
    updateHome(@Param() id: string,@Res() Res, @Body() UpdateHomeDto: UpdateHomeDto) {
        this.HomeService.updateHome(id,UpdateHomeDto).then((home) => {
